	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo $rowcat['subcatname']; ?></li>
			</ul>
		</div>
	</div>
  	<!-- /BREADCRUMB -->
					...
					<div id="store">
						...
						echo'<div class="col-md-4 col-sm-6 col-xs-6">
							...
							<div class="product product-single">
								...
								<h3 class="product-price">$ '.$rowproducts['productofferprice'].'<del class="product-old-price"> <i class="fas fa-rupee-sign"></i>'.$rowproducts['productprice'].'</del></h3>
